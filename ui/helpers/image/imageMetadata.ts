...
//
//   // If it's local, we can use the sizeOf method
//   directly, and pass the path of the image
//   if (!isExternal) {
//     // Calculate image resolution (width, height)
//     res = await sizeOf(path.join(process.cwd()
...
//       // Visit every node in the tree, check if it's
//       an image and push it in the images array
//       if (isImageNode(node)) {
//         images.push(node)
//       }
//     })
